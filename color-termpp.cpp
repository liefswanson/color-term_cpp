...
namespace term {
	...
	namespace bg {
		...
		const string red    = "\e[40m";
		const string green  = "\e[40m";
		const string yellow = "\e[40m";
		const string blue   = "\e[40m";
		const string purple = "\e[40m";
		const string cyan   = "\e[40m";
		const string white  = "\e[40m";
